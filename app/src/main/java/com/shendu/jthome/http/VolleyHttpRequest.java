...
import com.shendu.jthome.base.BaseApplication;
...
//    }
     ...
     * @param height
     */
    public static void imageLoader(String url, ImageView imageView, int width, int height) {
    ...
    static ImageLoader imageLoader = new ImageLoader(VolleyApplication.getQueue(), new VolleyBitmapCache());
     ...
     * @param default_image
     */
    public static void imageUrl(final String imageurl, final ImageView imageView, final int default_image) {
