...
package com.shendu.jthome.view.myview.staggeredgridview;
...
public class StaggeredGridView extends ExtendableListView {
    ...
    protected void onMeasureChild(final View child, final LayoutParams layoutParams) {
        ...
        if (viewType == ITEM_VIEW_TYPE_HEADER_OR_FOOTER ||
            ...
            if (DBG) Log.e(TAG, "onMeasureChild BEFORE position:" + position +
                    " h:" + getMeasuredHeight());
        ...
        if (DBG) Log.e(TAG, "onMeasureChild AFTER position:" + position +
                " h:" + childHeight);
    }
